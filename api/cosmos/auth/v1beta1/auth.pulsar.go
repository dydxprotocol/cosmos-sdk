...
var _ protoreflect.List = (*_AccountNonces_1_list)(nil)

type _AccountNonces_1_list struct {
	list *[]uint64
}

func (x *_AccountNonces_1_list) Len() int {
	if x.list == nil {
		return 0
	}
	return len(*x.list)
...
func (x *_AccountNonces_1_list) Get(i int) protoreflect.Value {
	return protoreflect.ValueOfUint64((*x.list)[i])
}

func (x *_AccountNonces_1_list) Set(i int, value protoreflect.Value) {
	valueUnwrapped := value.Uint()
	concreteValue := valueUnwrapped
	(*x.list)[i] = concreteValue
}

func (x *_AccountNonces_1_list) Append(value protoreflect.Value) {
	valueUnwrapped := value.Uint()
	concreteValue := valueUnwrapped
	*x.list = append(*x.list, concreteValue)
}

func (x *_AccountNonces_1_list) AppendMutable() protoreflect.Value {
	panic(fmt.Errorf("AppendMutable can not be called on message AccountNonces at list field Nonces as it is not of Message kind"))
}

func (x *_AccountNonces_1_list) Truncate(n int) {
	*x.list = (*x.list)[:n]
}

func (x *_AccountNonces_1_list) NewElement() protoreflect.Value {
	v := uint64(0)
	return protoreflect.ValueOfUint64(v)
}

func (x *_AccountNonces_1_list) IsValid() bool {
	return x.list != nil
}

var (
	md_AccountNonces        protoreflect.MessageDescriptor
	fd_AccountNonces_nonces protoreflect.FieldDescriptor
)

func init() {
	file_cosmos_auth_v1beta1_auth_proto_init()
	md_AccountNonces = File_cosmos_auth_v1beta1_auth_proto.Messages().ByName("AccountNonces")
	fd_AccountNonces_nonces = md_AccountNonces.Fields().ByName("nonces")
}

var _ protoreflect.Message = (*fastReflection_AccountNonces)(nil)

type fastReflection_AccountNonces AccountNonces

func (x *AccountNonces) ProtoReflect() protoreflect.Message {
	return (*fastReflection_AccountNonces)(x)
}

func (x *AccountNonces) slowProtoReflect() protoreflect.Message {
	mi := &file_cosmos_auth_v1beta1_auth_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
			ms.StoreMessageInfo(mi)
...
var _fastReflection_AccountNonces_messageType fastReflection_AccountNonces_messageType
var _ protoreflect.MessageType = fastReflection_AccountNonces_messageType{}

type fastReflection_AccountNonces_messageType struct{}

func (x fastReflection_AccountNonces_messageType) Zero() protoreflect.Message {
	return (*fastReflection_AccountNonces)(nil)
}
func (x fastReflection_AccountNonces_messageType) New() protoreflect.Message {
	return new(fastReflection_AccountNonces)
}
func (x fastReflection_AccountNonces_messageType) Descriptor() protoreflect.MessageDescriptor {
	return md_AccountNonces
}

// Descriptor returns message descriptor, which contains only the protobuf
// type information for the message.
func (x *fastReflection_AccountNonces) Descriptor() protoreflect.MessageDescriptor {
	return md_AccountNonces
}
...
// type information. If the Go type information is not needed,
// it is recommended that the message descriptor be used instead.
func (x *fastReflection_AccountNonces) Type() protoreflect.MessageType {
	return _fastReflection_AccountNonces_messageType
}

// New returns a newly allocated and mutable empty message.
func (x *fastReflection_AccountNonces) New() protoreflect.Message {
	return new(fastReflection_AccountNonces)
}

// Interface unwraps the message reflection interface and
// returns the underlying ProtoMessage interface.
func (x *fastReflection_AccountNonces) Interface() protoreflect.ProtoMessage {
	return (*AccountNonces)(x)
}
...
// While iterating, mutating operations may only be performed
// on the current field descriptor.
func (x *fastReflection_AccountNonces) Range(f func(protoreflect.FieldDescriptor, protoreflect.Value) bool) {
	if len(x.Nonces) != 0 {
		value := protoreflect.ValueOfList(&_AccountNonces_1_list{list: &x.Nonces})
		if !f(fd_AccountNonces_nonces, value) {
			return
		}
	}
}
...
// a proto3 scalar field is populated if it contains a non-zero value, and
// a repeated field is populated if it is non-empty.
func (x *fastReflection_AccountNonces) Has(fd protoreflect.FieldDescriptor) bool {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.AccountNonces.nonces":
		return len(x.Nonces) != 0
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.AccountNonces"))
		}
		panic(fmt.Errorf("message cosmos.auth.v1beta1.AccountNonces does not contain field %s", fd.FullName()))
	}
}
...
//
// Clear is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AccountNonces) Clear(fd protoreflect.FieldDescriptor) {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.AccountNonces.nonces":
		x.Nonces = nil
	default:
...
// For unpopulated composite types, it returns an empty, read-only view
// of the value; to obtain a mutable reference, use Mutable.
func (x *fastReflection_AccountNonces) Get(descriptor protoreflect.FieldDescriptor) protoreflect.Value {
	switch descriptor.FullName() {
	case "cosmos.auth.v1beta1.AccountNonces.nonces":
		if len(x.Nonces) == 0 {
			return protoreflect.ValueOfList(&_AccountNonces_1_list{})
		}
		listValue := &_AccountNonces_1_list{list: &x.Nonces}
		return protoreflect.ValueOfList(listValue)
	default:
		if descriptor.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.AccountNonces"))
		}
		panic(fmt.Errorf("message cosmos.auth.v1beta1.AccountNonces does not contain field %s", descriptor.FullName()))
	}
}
...
//
// Set is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AccountNonces) Set(fd protoreflect.FieldDescriptor, value protoreflect.Value) {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.AccountNonces.nonces":
		lv := value.List()
		clv := lv.(*_AccountNonces_1_list)
		x.Nonces = *clv.list
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.AccountNonces"))
...
//
// Mutable is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AccountNonces) Mutable(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.AccountNonces.nonces":
		if x.Nonces == nil {
			x.Nonces = []uint64{}
		}
		value := &_AccountNonces_1_list{list: &x.Nonces}
		return protoreflect.ValueOfList(value)
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.AccountNonces"))
...
// for the given descriptor. For scalars, this returns the default value.
// For lists, maps, and messages, this returns a new, empty, mutable value.
func (x *fastReflection_AccountNonces) NewField(fd protoreflect.FieldDescriptor) protoreflect.Value {
	switch fd.FullName() {
	case "cosmos.auth.v1beta1.AccountNonces.nonces":
		list := []uint64{}
		return protoreflect.ValueOfList(&_AccountNonces_1_list{list: &list})
	default:
		if fd.IsExtension() {
			panic(fmt.Errorf("proto3 declared messages do not support extensions: cosmos.auth.v1beta1.AccountNonces"))
		}
...
// returning nil if none are populated.
// It panics if the oneof descriptor does not belong to this message.
func (x *fastReflection_AccountNonces) WhichOneof(d protoreflect.OneofDescriptor) protoreflect.FieldDescriptor {
	switch d.FullName() {
	default:
		panic(fmt.Errorf("%s is not a oneof field in cosmos.auth.v1beta1.AccountNonces", d.FullName()))
	}
	panic("unreachable")
}
...
// The caller may only mutate the contents of the RawFields
// if the mutated bytes are stored back into the message with SetUnknown.
func (x *fastReflection_AccountNonces) GetUnknown() protoreflect.RawFields {
	return x.unknownFields
}
...
//
// SetUnknown is a mutating operation and unsafe for concurrent use.
func (x *fastReflection_AccountNonces) SetUnknown(fields protoreflect.RawFields) {
	x.unknownFields = fields
}
...
// Validity is not part of the protobuf data model, and may not
// be preserved in marshaling or other operations.
func (x *fastReflection_AccountNonces) IsValid() bool {
	return x != nil
}
...
// "google.golang.org/protobuf/runtime/protoiface".Methods.
// Consult the protoiface package documentation for details.
func (x *fastReflection_AccountNonces) ProtoMethods() *protoiface.Methods {
	size := func(input protoiface.SizeInput) protoiface.SizeOutput {
		x := input.Message.Interface().(*AccountNonces)
		if x == nil {
			return protoiface.SizeOutput{
				NoUnkeyedLiterals: input.NoUnkeyedLiterals,
				Size:              0,
	...
	unmarshal := func(input protoiface.UnmarshalInput) (protoiface.UnmarshalOutput, error) {
		...
		for iNdEx < l {
			...
			wireType := int(wire & 0x7)
			if wireType == 4 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: AccountNonces: wiretype end group for non-group")
			}
			if fieldNum <= 0 {
				return protoiface.UnmarshalOutput{NoUnkeyedLiterals: input.NoUnkeyedLiterals, Flags: input.Flags}, fmt.Errorf("proto: AccountNonces: illegal tag %d (wire type %d)", fieldNum, wire)
			}
			switch fieldNum {
			case 1:
				if wireType == 0 {
...
// AccountNonces defines a slice of nonces for each account.
...
func (x *AccountNonces) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*AccountNonces) ProtoMessage() {}

// Deprecated: Use AccountNonces.ProtoReflect.Descriptor instead.
func (*AccountNonces) Descriptor() ([]byte, []int) {
	return file_cosmos_auth_v1beta1_auth_proto_rawDescGZIP(), []int{4}
}

func (x *AccountNonces) GetNonces() []uint64 {
	if x != nil {
		return x.Nonces
	}
	return nil
...
var file_cosmos_auth_v1beta1_auth_proto_rawDesc = []byte{
	...
	,
...
var file_cosmos_auth_v1beta1_auth_proto_msgTypes = make([]protoimpl.MessageInfo, 5)
var file_cosmos_auth_v1beta1_auth_proto_goTypes = []interface{}{
	...
	(*AccountNonces)(nil),    // 4: cosmos.auth.v1beta1.AccountNonces
	(*anypb.Any)(nil),        // 5: google.protobuf.Any
}
var file_cosmos_auth_v1beta1_auth_proto_depIdxs = []int32{
	5, // 0: cosmos.auth.v1beta1.BaseAccount.pub_key:type_name -> google.protobuf.Any
...
func file_cosmos_auth_v1beta1_auth_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_cosmos_auth_v1beta1_auth_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*AccountNonces); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
